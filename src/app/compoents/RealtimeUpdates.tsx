...
const RenderText = ({ text }: RenderTextProps) => {
    ...
    <div>
      {
        [...messages].reverse().map((message, index) => (
          <div key={index} >
            <div className='mb-4 w-full font-mono border aspect-square p-4 grid place-items-center whitespace-pre-wrap break-all overflow-x-hidden overflow-y-auto'>
              {/* <p dangerouslySetInnerHTML={{ __html: message.decode_data }}></p> */}
              <RenderText text={message!.decode_data as string} />
            </div>
